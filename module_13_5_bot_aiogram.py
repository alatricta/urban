...
async def start_pogramm(message: Message, state: FSMContext):
    ...
    await message.reply('Сделай свой выбор:', reply_markup=kb)


@dp.message(F.text.casefold() == 'информация')
async def get_info(message: Message, state: FSMContext):
    info = 'Бот для расчёта оптимального потребления калорий в день'
